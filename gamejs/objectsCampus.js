...
let startGame = () => {
 ...
 /*HIER WEITER PFADE ANPASSEN*/ 
  ...
  lautstaerkesymbol = new PickObject('Lautstärkesymbol', 0.429688, 0.040278, 'screen01', 'Das ist ein Lautstärkesymbol', 'Campus/Bild_001/Objekte_ImBild/lautstaerkesymbol.png', 'Campus/Bild_001/Objekte_Inventar/lautstaerkesymbol.png');
  blindenbinde = new PickObject('Blindenbinde', 0.090625, 0.830556, 'screen01', 'Das ist eine Blindenbinde', 'Campus/Bild_001/Objekte_ImBild/blindenbinde.png', 'Campus/Bild_001/Objekte_Inventar/blindenbinde.png');
  c1 = new PickObject('C1', 0.817708, 0.243519, 'screen01', 'Das ist C1', 'Campus/Bild_001/Objekte_ImBild/c1.png', 'Campus/Bild_001/Objekte_Inventar/c1.png');
  fragezeichen = new PickObject('Fragezeichen', 0.853906, 0.5875, 'screen01', 'Das ist ein Fragezeichen', 'Campus/Bild_001/Objekte_ImBild/fragezeichen.png', 'Campus/Bild_001/Objekte_Inventar/fragezeichen.png');
  globus = new PickObject('Globus', 0.813281, 0.157407, 'screen01', 'Das ist ein Globus', 'Campus/Bild_001/Objekte_ImBild/globus.png', 'Campus/Bild_001/Objekte_Inventar/globus.png');
  kinderwagen = new PickObject('Kinderwagen', 0.206, 0.668056, 'screen01', 'Das ist ein Kinderwagen', 'Campus/Bild_001/Objekte_ImBild/kinderwagen.png', 'Campus/Bild_001/Objekte_Inventar/kinderwagen.png');
  kuscheltier = new PickObject('Kuscheltier', 0.636198, 0.494907, 'screen01', 'Das ist ein Kuscheltier', 'Campus/Bild_001/Objekte_ImBild/kuscheltier.png', 'Campus/Bild_001/Objekte_Inventar/kuscheltier.png');
  rollstuhl = new PickObject('Rollstuhl', 0.417708, 0.649074, 'screen01', 'Das ist ein Rollstuhl', 'Campus/Bild_001/Objekte_ImBild/rollstuhl.png', 'Campus/Bild_001/Objekte_Inventar/rollstuhl.png');
  stoppschild = new PickObject('Stoppschild', 0.340625, 0.686574, 'screen01', 'Das ist ein Stoppschild', 'Campus/Bild_001/Objekte_ImBild/stoppschild.png', 'Campus/Bild_001/Objekte_Inventar/stoppschild.png');
  windel = new PickObject('Windel', 0.723958, 0.668519, 'screen01', 'Das ist eine Windel', 'Campus/Bild_001/Objekte_ImBild/windel.png', 'Campus/Bild_001/Objekte_Inventar/windel.png');

  buecherzelle = new PickObject('Bücherzelle', 0.946354, 0.626389, 'screen02', 'Das ist eine Bücherzelle', 'Campus/Bild_002/Objekte_ImBild/buecherzelle.png', 'Campus/Bild_002/Objekte_Inventar/buecherzelle.png');
  jubelndePerson = new PickObject('Jubelnde_Person', 0.695313, 0.368981, 'screen02', 'Das ist eine jubelnde Person', 'Campus/Bild_002/Objekte_ImBild/jubelndeperson.png', 'Campus/Bild_002/Objekte_Inventar/jubelndeperson.png');
  karteikarten = new PickObject('Karteikarten', 0.916146, 0.868981, 'screen02', 'Das sind Karteikarten', 'Campus/Bild_002/Objekte_ImBild/karteikarten.png', 'Campus/Bild_002/Objekte_Inventar/karteikarten.png');
  lerngruppe = new PickObject('Lerngruppe', 0.449219, 0.742593, 'screen02', 'Das ist eine Lerngruppe', 'Campus/Bild_002/Objekte_ImBild/lerngruppe.png', 'Campus/Bild_002/Objekte_Inventar/lerngruppe.png');
  ordnerstapel = new PickObject('Ordnerstapel', 0.521094, 0.141667, 'screen02', 'Das ist eine Ordnerstapel', 'Campus/Bild_002/Objekte_ImBild/ordnerstapel.png', 'Campus/Bild_002/Objekte_Inventar/ordnerstapel.png');
  personMitSchweiss = new PickObject('Person_mit_Schweiß', 0.013802, 0.685648, 'screen02', 'Das ist eine Person mit Schweiß', 'Campus/Bild_002/Objekte_ImBild/personmitschweiss.png', 'Campus/Bild_002/Objekte_Inventar/personmitschweiss.png');
  stoppuhr = new PickObject('Stoppuhr', 0.11276, 0.067593, 'screen02', 'Das ist eine Stoppuhr', 'Campus/Bild_002/Objekte_ImBild/stoppuhr.png', 'Campus/Bild_002/Objekte_Inventar/stoppuhr.png');
  stundenplan = new PickObject('Stundenplan', 0.95026, 0.118519, 'screen02', 'Das ist ein Stundenplan', 'Campus/Bild_002/Objekte_ImBild/stundenplan.png', 'Campus/Bild_002/Objekte_Inventar/stundenplan.png');
  todoliste = new PickObject('Todoliste', 0.607552, 0.443981, 'screen02', 'Das ist eine To Do Liste', 'Campus/Bild_002/Objekte_ImBild/todoliste.png', 'Campus/Bild_002/Objekte_Inventar/todoliste.png');
  umleitungsschild = new PickObject('Umleitungsschild', 0.455469, 0.706944, 'screen02', 'Das ist ein Umleitungsschild', 'Campus/Bild_002/Objekte_ImBild/umleitungsschild.png', 'Campus/Bild_002/Objekte_Inventar/umleitungsschild.png');
